...
<html lang="en">
	...
	<head><base href="">
		<meta charset="utf-8" />
		<title>Administrator | Viewpama</title>
		...
		<!--end::Layout Themes-->
		<link href="<?= base_url(); ?>assets-backend/plugins/dropify/css/dropify.min.css" rel="stylesheet">
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" class="header-fixed header-mobile-fixed fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		<!--begin::Main-->
		<!--begin::Header Mobile-->
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="<?= base_url(); ?>assets-backend/media/logos/logo-light3.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
			<div class="d-flex align-items-center">
				<!--begin::Aside Mobile Toggle-->
				<button class="btn p-0 p-0 burger-icon ml-4" id="kt_aside_mobile_toggle">
					<span></span>
				</button>
