    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" action="<?= base_url('administrator/add_category') ?>" method="post" enctype="multipart/form-data">                        
                        ...
                        <?php echo $error;?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="file" name="b" class="dropify" data-default-file="" >
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input class="form-control" type="text" name="c"  value="" id="example-email-input" />
                                    </div>
                                </div>
